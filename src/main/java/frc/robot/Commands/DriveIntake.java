...
public class DriveIntake extends Command {
  ...
  public DriveIntake(Drivetrain drivetrain, DoubleSupplier xSupplier, DoubleSupplier ySupplier) {
  ...
  public void execute() {
    ...
    double leftAngle = Math.atan2(YRawDemand,XRawDemand); 
    ...
    double rotDemand = rotPID.calculate(MathUtil.angleModulus(drivetrain.getPose().getRotation().getRadians()), leftAngle);
